...
double generalized_logistic_model(
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> theta_r,
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> theta_s,
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> eta_pr,
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> eta_sr,
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> eta_ps,
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> eta_ss,
