#ifndef STAN_MATH_OPENCL_PRIM_ONE_HOT_ARRAY_HPP
#define STAN_MATH_OPENCL_PRIM_ONE_HOT_ARRAY_HPP
#ifdef STAN_OPENCL
...
inline auto one_hot_array(int K, int k) {
  static const char* function = "one_hot_array (OpenCL)";
