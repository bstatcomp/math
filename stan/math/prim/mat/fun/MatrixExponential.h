...
namespace Eigen {
  ...
  {  
    ...
    using RealScalar = typename Eigen::NumTraits<typename traits<MatrixType>::Scalar>::Real;  
  ...
  {  
    using RealScalar = typename Eigen::NumTraits<typename Eigen::internal::traits<MatrixType>::Scalar>::Real;  
