#ifndef STAN_MATH_OPENCL_PRIM_ZEROS_ARRAY_HPP
#define STAN_MATH_OPENCL_PRIM_ZEROS_ARRAY_HPP
#ifdef STAN_OPENCL
...
inline auto zeros_array(int K) {
  check_nonnegative("zeros_array(OpenCL)", "size", K);
