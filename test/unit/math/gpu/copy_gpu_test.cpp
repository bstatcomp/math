...
TEST(MathMatrixGPU, copy_submatrix_exception) {
  ...
  EXPECT_THROW(stan::math::copy_submatrix(d11, d22, 1, 1, 0, 0, 4, 4), std::domain_error);
  EXPECT_THROW(stan::math::copy_submatrix(d11, d22, 4, 4, 0, 0, 2, 2), std::domain_error);
  EXPECT_THROW(stan::math::copy_submatrix(d11, d22, 1, 1, 3, 3, 4, 4), std::domain_error);
  EXPECT_THROW(stan::math::copy_submatrix(d11, d22, 1, 1, 3, 3, 3, 3), std::domain_error);
}
