#ifndef STAN_MATH_OPENCL_PRIM_ONES_ARRAY_HPP
#define STAN_MATH_OPENCL_PRIM_ONES_ARRAY_HPP
#ifdef STAN_OPENCL
...
inline auto ones_array(int K) {
  check_nonnegative("ones_array(OpenCL)", "size", K);
  return constant(1.0,K,1);
}
}  // namespace math
}  // namespace stan
#endif
