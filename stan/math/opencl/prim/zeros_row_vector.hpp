#ifndef STAN_MATH_OPENCL_PRIM_ZEROS_ROW_VECTOR_HPP
#define STAN_MATH_OPENCL_PRIM_ZEROS_ROW_VECTOR_HPP
#ifdef STAN_OPENCL
...
inline auto zeros_row_vector(int K) {
  check_nonnegative("zeros_row_vector(OpenCL)", "size", K);
  return constant(0.0,1,K);
}
}  // namespace math
}  // namespace stan
#endif
